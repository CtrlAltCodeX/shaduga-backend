    ...
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        ...
        <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
            ...
            <li class="nav-item dropdown"> 
                ...
                <!-- <i class="bi bi-chat-text"></i> <span class="navbar-badge badge text-bg-danger">3</span> </a> -->
            ...
            <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <span class="d-none d-md-inline">{{ auth()->user()->name }}</span> </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                    <li class="user-header text-bg-primary">
                        <img src="{{auth()->user()->profile_url ? auth()->user()->profile_url : 'dummy.jpg'}}" class="rounded-circle shadow" alt="User Image">
                        <p>
                            {{ auth()->user()->name }}
                        </p>
